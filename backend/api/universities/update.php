...
$q=image_size_prepare($db,'universities','UPDATE universities SET nombre=:nombre,slug=:slug,logo=:logo,descripcion=:descripcion,imagen_portada=:imagen_portada,tamano_logo=:tamano_logo,tamano_portada=:tamano_portada,orden=:orden,activo=:activo WHERE id=:id',$values);
