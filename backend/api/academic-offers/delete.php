...
$db=get_database();$q=$db->prepare('DELETE FROM university_academic_offers WHERE id=:id AND university_id=:parent');$q->execute(['id'=>$id,'parent'=>$parent]);
if(!$q->rowCount())error_response('Oferta no encontrada.',404);
