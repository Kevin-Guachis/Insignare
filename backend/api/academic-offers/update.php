...
$q=image_size_prepare($db,'university_academic_offers','UPDATE university_academic_offers SET titulo=:titulo,descripcion=:descripcion,imagen=:imagen,tamano_imagen=:tamano_imagen,documento=:documento,documento_nombre=:documento_nombre,boton_texto=:boton_texto,boton_url=:boton_url,orden=:orden,activo=:activo WHERE id=:id AND university_id=:university_id',$values);
