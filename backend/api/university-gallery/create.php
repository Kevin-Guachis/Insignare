...
$q=image_size_prepare($db,'university_gallery','INSERT INTO university_gallery (university_id,titulo,descripcion,imagen,tamano_imagen,orden,activo) VALUES (:university_id,:titulo,:descripcion,:imagen,:tamano_imagen,:orden,:activo)',$values);
